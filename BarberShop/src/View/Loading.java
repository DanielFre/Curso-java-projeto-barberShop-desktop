...
public class Loading extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setAlwaysOnTop(true);
        setMaximumSize(new java.awt.Dimension(400, 84));
        setMinimumSize(new java.awt.Dimension(400, 84));
        setResizable(false);
        setSize(new java.awt.Dimension(400, 84));

        jLTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLTitle.setText("Salvando Agendamento...");

        jProgressBar.setBackground(new java.awt.Color(0, 0, 0));
        jProgressBar.setForeground(new java.awt.Color(0, 204, 0));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jProgressBar, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
